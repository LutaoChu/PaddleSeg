...
class MscaleOCRFinetune(fluid.dygraph.Layer):
...
#         return output_dict
    ...
    def single_scale_forward(self, x0):
        ...
        #         exit()
        return {'cls_out': x17, 'aux_out': x12, 'logit_attn': x22}
...
class Ocr_ocr_distri_head_object_context_block_f_pixel(fluid.dygraph.Layer):
    def __init__(
        ...
        super(Ocr_ocr_distri_head_object_context_block_f_pixel,
              self).__init__()
        self.conv0 = paddle.nn.Conv2D(
            out_channels=256,
            kernel_size=(1, 1),
...
class Backbone_transition3_3(fluid.dygraph.Layer):
    def __init__(
        ...
        self.backbone_transition3_3_00 = Backbone_transition3_3_0(
            params=params)
...
class Backbone_transition2_2(fluid.dygraph.Layer):
    def __init__(
        ...
        self.backbone_transition2_2_00 = Backbone_transition2_2_0(
            params=params)
...
class Backbone_transition1_1(fluid.dygraph.Layer):
    def __init__(
        ...
        self.backbone_transition1_1_00 = Backbone_transition1_1_0(
            params=params)
...
class Backbone_stage3(fluid.dygraph.Layer):
    ...
    def forward(self, x0, x1, x2):
        x3, x4, x5 = self.highresolutionmodule60(x0, x1, x2)
        x6, x7, x8 = self.highresolutionmodule00(x3, x4, x5)
        x9, x10, x11 = self.highresolutionmodule40(x6, x7, x8)
        x12, x13, x14 = self.highresolutionmodule20(x9, x10, x11)
        return x12, x13, x14
...
class Backbone_stage4(fluid.dygraph.Layer):
    ...
    def forward(self, x0, x1, x2, x3):
        x4, x5, x6, x7 = self.highresolutionmodule10(x0, x1, x2, x3)
        x8, x9, x10, x11 = self.highresolutionmodule30(x4, x5, x6, x7)
...
class Backbone_stage2(fluid.dygraph.Layer):
    ...
    def forward(self, x0, x1):
        x2, x3 = self.highresolutionmodule70(x0, x1)
        return x2, x3
